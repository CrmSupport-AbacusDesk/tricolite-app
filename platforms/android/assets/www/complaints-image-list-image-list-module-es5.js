...
var ImageListPageRoutingModule = /** @class */ (function () {
    function ImageListPageRoutingModule() {
    }
...
var ImageListPageModule = /** @class */ (function () {
    function ImageListPageModule() {
    }
...
var ImageListPage = /** @class */ (function () {
    ...
    ImageListPage.prototype.ngOnInit = function () {
    };
    ImageListPage.prototype.GoToImageGalley = function () {
        this.router.navigateByUrl('/technicians/image-gallery');
    };
    ImageListPage.prototype.GoToImages = function () {
    ...
    ImageListPage.prototype.GoComplaintDetail = function () {
        this.location.back();
    };
    ImageListPage.ctorParameters = function () { return [
