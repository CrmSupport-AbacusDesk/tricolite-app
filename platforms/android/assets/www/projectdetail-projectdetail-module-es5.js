...
var ProjectdetailPageRoutingModule = /** @class */ (function () {
    function ProjectdetailPageRoutingModule() {
    }
...
var ProjectdetailPage = /** @class */ (function () {
    function ProjectdetailPage(popoverController, route, routeParams, formBuilder, alertCtrl, dbService) {
    ...
    ProjectdetailPage.prototype.onGetProjectDetail = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.dbService.onPostRequestHandler(inputData, 'customer/getProjectList').subscribe(function (result) {
                    ...
                    _this.projectData = result["projectContactList"][0];
    ...
    ProjectdetailPage.prototype.onSaveContactDetailHandler = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var contactTempData = JSON.parse(JSON.stringify(_this.data));
                                        var inputData = {};
                                        inputData["projectId"] = _this.projectId;
                                        inputData["contactData"] = [];
                                        inputData["contactData"].push(contactTempData);
                                        _this.dbService.presentLoader();
                                        _this.dbService.onPostRequestHandler(inputData, 'customer/saveProjectContact').subscribe(function (result) {
                                            console.log(result);
                                            _this.dbService.dismissLoader();
                                            if (result["status"] == 'error') {
                                                ...
                                                _this.activeTab = 2;
                                                _this.onGetProjectDetail();
                                                _this.dbService.presentToast('Contact Saved Successfully!');
                                            }
                                        });
                                    }
                                }
    ...
    Object.defineProperty(ProjectdetailPage.prototype, "f1", {
        get: function () { return this.registerForm1.controls; },
        enumerable: true,
        configurable: true
    });
    ProjectdetailPage.ctorParameters = function () { return [
