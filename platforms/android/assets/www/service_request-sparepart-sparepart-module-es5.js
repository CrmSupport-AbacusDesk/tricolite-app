...
var SparepartPageRoutingModule = /** @class */ (function () {
    function SparepartPageRoutingModule() {
    }
    ...
    return SparepartPageRoutingModule;
}());
...
var SparepartPage = /** @class */ (function () {
    function SparepartPage(popoverController, router) {
        this.popoverController = popoverController;
        this.router = router;
    }
    SparepartPage.prototype.ngOnInit = function () {
    };
    SparepartPage.prototype.presentcutomerPopover = function (ev) {
    ...
    SparepartPage.prototype.GoToDetail = function () {
...
//# sourceMappingURL=service_request-sparepart-sparepart-module-es5.js.map