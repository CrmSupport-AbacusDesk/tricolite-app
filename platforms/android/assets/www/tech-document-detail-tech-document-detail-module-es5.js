...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tech-document-detail-tech-document-detail-module"], {
  ...
  function srcAppTechnician_appTechDocumentDetailTechDocumentDetailRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TechDocumentDetailPageRoutingModule = function TechDocumentDetailPageRoutingModule() {
      _classCallCheck(this, TechDocumentDetailPageRoutingModule);
    };
  ...
  function srcAppTechnician_appTechDocumentDetailTechDocumentDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TechDocumentDetailModule = function TechDocumentDetailModule() {
      _classCallCheck(this, TechDocumentDetailModule);
    };
  ...
  function srcAppTechnician_appTechDocumentDetailTechDocumentDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TechDocumentDetailPage = /*#__PURE__*/function () {
      function TechDocumentDetailPage(popoverController, actionCtrl, router, routeParams, alertCtrl, toastCtrl, diagnostic, camera, imagePicker, base64, dbService, photoViewer) {
        ...
        _classCallCheck(this, TechDocumentDetailPage);
      ...
      _createClass(TechDocumentDetailPage, [{
        key: "ngOnInit",
    ...
    TechDocumentDetailPage.ctorParameters = function () {
      return [{
